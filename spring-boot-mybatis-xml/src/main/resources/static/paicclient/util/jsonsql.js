...
(function () {
    ...
    jsonsql.prototype.query = function(sql,json){
    ...
    jsonsql.prototype.parse = function(json,ops){
    ...
    jsonsql.prototype.returnFilter = function(json,jsonsql_o){
    ...
    jsonsql.prototype.returnFields = function(scope,fields){
        if(fields.length == 0)
            fields = ["*"];
        if(fields[0] == "*")
            return scope;
    ...
    jsonsql.prototype.returnOrderBy = function(result,orderby,order){
        if(orderby.length == 0)
            return result;
    ...
    jsonsql.prototype.returnLimit = function(result,limit){
        switch(limit.length){
    ...
    bison.util.jsonsql = new jsonsql();
}());